    ...
    <div className='flex-1 flex flex-col xl:flex-row p-4 gap-4'>
      ...
      <div className='w-full xl:w-2/3'>
        ...
        <div className='flex flex-col lg:flex-row gap-4'>
          ...
          <div className='bg-blue-200 px-4 py-6 rounded-md flex-1 flex gap-4'>
            <div className='w-1/3'>
              <Image src="https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=1200" alt='' height={144} width={144} className='h-36 w-36 rounded-full object-cover'/>
            </div>
            ...
            <div className='flex items-center gap-4'>
              ...
              <FormModal table='teacher' type='update' data={{
                id: 1,
                username: "deanguerrero@gmail.com",
                password: "password",
                firstName: "Dean",
                lastName: "Guerrero",
                phone: "+1 234 567 89",
      ...
      <div className='bg-white rounded-md p-4'>
        ...
        <div className='mt-4 flex gap-4 flex-wrap text-xs text-gray-500'>
          ...
          <Link className='p-3 rounded-md bg-amber-100' href="/">Teacher&apos;s Lessons</Link>
          <Link className='p-3 rounded-md bg-pink-100' href="/">Teacher&apos;s Exams</Link>
          <Link className='p-3 rounded-md bg-green-100' href="/">Teacher&apos;s Assignmens</Link>
        </div>
      </div>
      <Performance />
      <Announcements />
